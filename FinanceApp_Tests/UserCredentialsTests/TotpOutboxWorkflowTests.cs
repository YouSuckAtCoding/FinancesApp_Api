...
public class TotpOutboxWorkflowTests : IClassFixture<SqlFixture>
{
    ...
    public async Task TotpProjection_Should_Receive_Events_Via_Dispatcher()
    {
        ...
        var createdEvt = new TotpCredentialCreatedEvent(Guid.NewGuid(), DateTimeOffset.UtcNow, Guid.NewGuid(), "JBSWY3DPEHPK3PXP");
        var invalidatedEvt = new TotpCredentialInvalidatedEvent(Guid.NewGuid(), DateTimeOffset.UtcNow, Guid.NewGuid());
